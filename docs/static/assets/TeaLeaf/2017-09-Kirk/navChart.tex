...
\begin{tikzpicture}
    ...
    \begin{axis}
        ...
        \addplot+ [semithick, OpenMP, mark options={fill=OpenMP}, mark=*, mark options={style={solid}}] coordinates { (1.0, 0.0) };
        \addlegendentry{OpenMP}
        \addplot+ [forget plot, semithick, OpenMP, only marks, mark size=8, mark=square] coordinates { (1.0, 0.0) };

        \addplot+ [semithick, MPI, mark options={fill=MPI}, mark=*, mark options={style={solid}, scale=1.5}] coordinates { (1.0, 0.0) };
        \addlegendentry{MPI}
        \addplot+ [forget plot, semithick, MPI, only marks, mark size=8, mark=square] coordinates { (1.0, 0.0) };

        \addplot+ [semithick, Hybrid, mark options={fill=Hybrid}, mark=triangle*, mark options={style={solid}, scale=1.5, rotate=180}] coordinates { (1.0, 0.0) };
        \addlegendentry{Hybrid}
        \addplot+ [forget plot, semithick, Hybrid, only marks, mark size=8, mark=square] coordinates { (1.0, 0.0) };

        \addplot+ [semithick, CUDA, mark options={fill=CUDA}, mark=triangle*, mark options={style={solid}, scale=1.5}] coordinates { (1.0, 0.0) };
        \addlegendentry{CUDA}
        \addplot+ [forget plot, semithick, CUDA, only marks, mark size=8, mark=square] coordinates { (1.0, 0.0) };

        \addplot+ [semithick, OpenACC, mark options={fill=OpenACC}, mark=triangle*, mark options={style={solid}, scale=1.5, rotate=90}] coordinates { (1.0, 0.0) };
        \addlegendentry{OpenACC}
        \addplot+ [forget plot, semithick, OpenACC, only marks, mark size=8, mark=square] coordinates { (1.0, 0.0) };

        \addplot+ [semithick, OPS, mark options={fill=OPS}, mark=triangle*, mark options={style={solid}, scale=1.5, rotate=270}] coordinates { (1.0, 0.4960712015030751) };
        \addlegendentry{OPS}
        \addplot+ [forget plot, semithick, OPS, only marks, mark size=8, mark=square] coordinates { (1.0, 0.4960712015030751) };

        \addplot+ [semithick, Kokkos, mark options={fill=Kokkos}, mark=pentagon*, mark options={style={solid}, scale=1.5}] coordinates { (1.0, 0.0) };
